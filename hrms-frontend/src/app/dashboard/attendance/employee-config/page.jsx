...
//     setSuccess("");
//     try {
//       await api.post("/api/v1/add/employee/attendance_config", {
...
//     e.preventDefault();
//     if (!configId.trim()) return setError("Config ID required for update");
//     setSaving(true);
//     setError("");
//     setSuccess("");
//     try {
//       await api.put(`/api/v1/update/employee/attendance_config/${configId.trim()}`, {
//         employee_id: form.employee_id,
//         grace_minutes_override: form.grace_minutes_override
//           ? Number(form.grace_minutes_override)
//           : null,
...
//       <div className="mb-6">
//         <h1 className="text-[22px] font-semibold text-[#1a1a1a]">Employee Attendance Config</h1>
//         <p className="mt-1 text-sm text-[#6b7280]">
//           Per-employee overrides (null = company policy)
//         </p>
//       </div>
...
//           <h2 className="text-sm font-semibold text-[#374151]">Create / Update</h2>
//         </div>
...
//               onChange={(e) =>
//                 setForm((p) => ({ ...p, grace_minutes_override: e.target.value }))
//               }
//               className="w-full rounded-md border border-[#d1d5db] px-3 py-2.5 text-sm"
//             />
//           </div>
//           <div>
//             <label className="mb-1 block text-sm font-medium text-[#374151]">Geo fence required</label>
//             <select
//               value={form.geo_fence_required}
//               onChange={(e) => setForm((p) => ({ ...p, geo_fence_required: e.target.value }))}
//               className="w-full rounded-md border border-[#d1d5db] px-3 py-2.5 text-sm"
//             >
...
//           </div>
//           <div>
//             <label className="mb-1 block text-sm font-medium text-[#374151]">Face required</label>
//             <select
//               value={form.face_required}
//               onChange={(e) => setForm((p) => ({ ...p, face_required: e.target.value }))}
//               className="w-full rounded-md border border-[#d1d5db] px-3 py-2.5 text-sm"
//             >
//               <option value="">Company default</option>
//               <option value="true">Yes</option>
...
//           </div>
//           <div>
//             <label className="mb-1 block text-sm font-medium text-[#374151]">Allow web punch</label>
//             <select
//               value={form.allow_web_punch}
//               onChange={(e) => setForm((p) => ({ ...p, allow_web_punch: e.target.value }))}
//               className="w-full rounded-md border border-[#d1d5db] px-3 py-2.5 text-sm"
//             >
//               <option value="">Company default</option>
//               <option value="true">Yes</option>
...
//           </div>
//           <div>
//             <label className="mb-1 block text-sm font-medium text-[#374151]">Allow mobile punch</label>
//             <select
//               value={form.allow_mobile_punch}
//               onChange={(e) => setForm((p) => ({ ...p, allow_mobile_punch: e.target.value }))}
//               className="w-full rounded-md border border-[#d1d5db] px-3 py-2.5 text-sm"
//             >
//               <option value="">Company default</option>
//               <option value="true">Yes</option>
...
//           </div>
//           <div>
//             <label className="mb-1 block text-sm font-medium text-[#374151]">WFH allowed</label>
//             <select
//               value={form.wfh_allowed}
//               onChange={(e) => setForm((p) => ({ ...p, wfh_allowed: e.target.value }))}
//               className="w-full rounded-md border border-[#d1d5db] px-3 py-2.5 text-sm"
//             >
//               <option value="">Company default</option>
//               <option value="true">Yes</option>
...
//             <label className="mb-1 block text-sm font-medium text-[#374151]">Remarks</label>
//             <input
//               value={form.remarks}
...
//               disabled={saving}
//               onClick={create}
//               className="rounded-md bg-[#E42527] px-4 py-2.5 text-sm font-medium text-white hover:bg-[#c91f21] disabled:opacity-60"
//             >
