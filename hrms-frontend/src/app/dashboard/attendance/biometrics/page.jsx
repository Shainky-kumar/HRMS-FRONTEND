...
//   const openAdd = () => {
//     setEditId(null);
//     setForm({ employee_id: "", face_image_url: "", device_id: "", is_active: true });
//     setShowForm(true);
//     setError("");
//     setSuccess("");
//   };
...
//         setSuccess("Biometric updated successfully");
//       } else {
...
//           <p className="mt-1 text-sm text-[#6b7280]">Face enrollment for attendance</p>
//         </div>
//         <button
//           onClick={openAdd}
...
//             placeholder="Search employee / biometric..."
//             className="rounded-lg border px-3 py-2 text-sm focus:border-[#E42527] focus:outline-none"
//           />
//           <button
//             onClick={() => {
//               setPage(1);
...
//           ) : list.length === 0 ? (
//             <div className="py-16 text-center text-sm text-[#6b7280]">No biometrics found</div>
//           ) : (
//             <table className="w-full min-w-[700px] text-left text-sm">
//               <thead>
//                 <tr className="border-b bg-[#f9fafb]">
//                   <th className="px-5 py-3 font-medium text-[#6b7280]">Employee</th>
//                   <th className="px-5 py-3 font-medium text-[#6b7280]">Face URL</th>
...
//                 {list.map((row) => (
//                   <tr key={row.biometric_id} className="hover:bg-[#fafafa]">
...
//               </div>
//               <div>
//                 <label className="mb-1 block text-sm font-medium">Face Image URL</label>
//                 <input
//                   value={form.face_image_url}
//                   onChange={(e) => setForm((p) => ({ ...p, face_image_url: e.target.value }))}
...
//       // thoda wait karke video attach karo
//       setTimeout(() => {
//         if (videoRef.current) {
...
//       setError("Please capture face photo");
//       setSaving(false);
//       return;
//     }
...
//               <div>
//                 <label className="mb-1 block text-sm font-medium text-[#374151]">
//                   Face Photo <span className="text-[#E42527]">*</span>
//                 </label>
...
//                         className="rounded-md bg-[#E42527] px-4 py-2 text-sm font-medium text-white"
//                       >
//                         📷 Capture
//                       </button>
//                       <button
...
//                     type="button"
//                     onClick={openCamera}
//                     className="w-full rounded-md border border-[#E42527] py-3 text-sm font-medium text-[#E42527] hover:bg-red-50"
//                   >
//                     📷 Open Camera
//                   </button>
//                 )}
