...
// const settingsTabs = [
//   { label: "Working Hours", href: "/dashboard/settings/working-hours" },
...
//   // { label: "Map Category Shift", href: "/dashboard/shift-management/map-category" },
// ];

// // ✅ Attendance top tabs (tumhari APIs ke hisaab se)
